...
AIC(FHV_aov1, FHV_aov1) 
AIC(FHV_aov1, FHV_aov3)
AIC(FHV_aov1, FHV_aov4)
...
shapiro.test(x = residuals(FHV_aov1))

# 3. Outliers 
plot(FHV_aov1, 1)
outlierTest(FHV_aov1)
```
# Graphing - ANOVA
