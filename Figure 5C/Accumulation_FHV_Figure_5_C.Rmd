...
# Rationale 
To determine if Wolbachia and time has an impact on accumulation of FHV viral RNA in flies. 
...
FHV_aov2_fitted <- fitted(FHV_aov2)
FHV_aov2_res <- residuals(FHV_aov2)
...
sink("Accumulation_FHV_Figure_5_C_stats_output_anova.txt") # change file name
summary(FHV_aov2) # prints coxme output to txt file
sink() # closes the connection **CRITICAL**

sink("Accumulation_FHV_Figure_5_C_stats_output_anova_call.txt") # change file name
print(FHV_aov2) # prints coxme output to txt file
sink() # closes the connection **CRITICAL**

# Exporting figure
today <- Sys.Date()
date <- format(today, format = "%y%m%d")
name <- paste(date, "Figure", "5", "C",  sep = "_")
