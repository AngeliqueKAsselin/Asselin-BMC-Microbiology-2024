---
title: "Survival FHV Original Figure 1C"
...
```{r Importing Data}
data_FHV <- read.csv("Survival_Original_FHV_Figure_1_data.csv")
```
...
write.csv(df_cox, file = "Survival_FHV_Figure_1_coxme_HR_output.csv", row.names = FALSE)

# Saving coxme plot 
ggsave("Survival_FHV_Figure_1_coxme_plot_output.pdf", 
       plot = plot_coxme, 
       height = 7.5, 
       width = 15) 
