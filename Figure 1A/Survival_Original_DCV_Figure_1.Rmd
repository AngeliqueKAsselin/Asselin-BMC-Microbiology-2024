---
title: "Survival DCV Original Figure 1A"
...
```{r Importing data}
data_DCV <- read.csv("Survival_Original_DCV_Figure_1_data.csv")
```
...
write.csv(df_join, file = "Survival_DCV_Figure_1_coxme_HR_output.csv", row.names = FALSE)

# Saving coxme and weibull plot 
ggsave("Survival_DCV_Figure_1_coxme_plot_output.pdf", 
       plot = plot_all, 
       height = 7.5, 
       width = 15) 

# Saving Kaplan-Meire survival curves
ggsave("Survival_DCV_Figure_1_curves_plot_output.pdf", 
       plot = graph_DCV$plot, 
       height = 7.5, 
       width = 15)
```